...
type OrderClient interface {
	CreateSo(ctx context.Context, in *CreateSoReq, opts ...grpc_go.CallOption) (*CreateSoResp, common.ErrorWithAttachment)
}
...
type OrderClientImpl struct {
	CreateSo func(ctx context.Context, in *CreateSoReq) (*CreateSoResp, error)
}
...
func (c *orderClient) CreateSo(ctx context.Context, in *CreateSoReq, opts ...grpc_go.CallOption) (*CreateSoResp, common.ErrorWithAttachment) {
	out := new(CreateSoResp)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/CreateSo", in, out)
}
...
type OrderServer interface {
	CreateSo(context.Context, *CreateSoReq) (*CreateSoResp, error)
...
func (UnimplementedOrderServer) CreateSo(context.Context, *CreateSoReq) (*CreateSoResp, error) {
...
func _Order_CreateSo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	invo := invocation.NewRPCInvocation("CreateSo", args, invAttachment)
	if interceptor == nil {
		result := base.XXX_GetProxyImpl().Invoke(ctx, invo)
		return result, result.Error()
	}
...
var Order_ServiceDesc = grpc_go.ServiceDesc{
	...
	Methods: []grpc_go.MethodDesc{
		{
			MethodName: "CreateSo",
			Handler:    _Order_CreateSo_Handler,
		},
	},
	Streams:  []grpc_go.StreamDesc{},
	Metadata: "api.proto",
